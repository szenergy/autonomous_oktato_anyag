...
![wsl áttekintés](/szenergy-autonom/assets/images_common/wsl_overview01.svg)
...
Gépteremben a [következő `install_humble.sh`](https://github.com/sze-info/szenergy-autonom/blob/main/docs/telepites/install_humble.sh) fájlt (shell scriptet) futtatuk minden gépen.

``` bash
wget https://raw.githubusercontent.com/sze-info/szenergy-autonom/main/docs/telepites/install_humble.sh
```
``` bash
...
``` bash
cd ~ ; rm ws_reset.sh; wget https://raw.githubusercontent.com/sze-info/szenergy-autonom/main/docs/telepites/ws_reset.sh; sudo chmod +x ws_reset.sh; ./ws_reset.sh
```
