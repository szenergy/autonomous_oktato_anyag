...
4. **Szabályozás**: a tervező által előállított útvonal, vagy tszenergy-autonomektória lekövetése, például Pure-Pursuit szabályzó, Modell Prediktív Szabályzó (Model Predictive Control, MPC) stb. segítségével.
...
## Szenergy (autó)
Szenzorai: Ouster OS1-128 LIDAR, Stereolabs Zed2i mélységkamera.
...
A Szenergy csapata európa legnagyobb önvezető versenyén, a Shell Eco-marathon Autonomous Urban Concept (AUC) versenyen 2023-ban és 2024-ben is első, előtte pedig második helyezést ért el. A doboogós helyezések ezekben az évek ben így alakultak:
