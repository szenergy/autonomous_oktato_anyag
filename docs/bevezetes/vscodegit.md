...
![vs code alapok](/szenergy-autonom/assets/images_common/vscodebasics01.png)
...
!!! tip
    A VS Code-ot megnyithatjuk egy Git-repo könyvtárában. Ehhez a parancs a könytárban állva: `code .` illetve pl: `code ~/ros2_ws/src/szenergy-autonom_packages/`, ha a tantárgy `szenergy-autonom_packages` repoját szereténk megnyitni. A VS Code Git szolgáltatásai továbbra is a szokásos módon működnek, és minden változást megjelenítenek a tárolón belül, de a hatókörű könyvtáron kívüli fájlmódosítások egy eszköztippel vannak árnyékolva, jelezve, hogy az aktuális munkaterületen kívül helyezkednek el.
...
<figure markdown="span">
  ![](/szenergy-autonom/assets/images_common/includepath_settings01.png)
...
<figure markdown="span">
  ![](/szenergy-autonom/assets/images_common/includepath_settings02.png)
